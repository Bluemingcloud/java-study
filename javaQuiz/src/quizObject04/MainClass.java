...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		cal.add(4);
		cal.add(5);
		System.out.println("계산기로 누적 덧셈 값 : " + cal.result);
		
		System.out.println("계산기로 원의 넓이 : " + cal.circle(5));		
		
		Computer com = new Computer();
		System.out.println("컴퓨터로 누적 덧셈 값 : " + com.add(10));
		System.out.println("컴퓨터로 원의 넓이 : " + com.circle(5));
		
		System.out.println("사각형의 넓이 : " + com.rect(10));
		System.out.println("직사각형의 넓이 : " + com.rect(5,4));
		System.out.println("육면체의 부피 : " + com.rect(5,4,3));
	}
